...
public class EmptransferController {
    ...
    //删除
    @DeleteMapping("/emptransfer/{id}")
    public String deleteEmptransfereById(@PathVariable("id") Integer id){
        emptransferService.deleteEmptransfer(id);
        return "redirect:/emptransfers";
    }
